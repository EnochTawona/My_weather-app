...
function setBackground(description) {
    if (description.includes('rain')) document.body.style.background = 'url("pictures/pexels-chetanvlad-1529360.jpg")';
    else if (description.includes('clear')) document.body.style.background = 'url("pictures/pexels-trvlust-2837572.jpg")';
    else if (description.includes('cloud')) document.body.style.background = 'url("pictures/pexels-valery-697423-1546464.jpg")';
    else if (description.includes('snow')) document.body.style.background = 'url("pictures/pexels-pixabay-66284.jpg")';
